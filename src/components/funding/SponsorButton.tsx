...
import { GoHeart, GoChevronDown, GoArrowRight } from "react-icons/go";
      ...
      <Tooltip.Root>
        ...
        <Tooltip.Positioner>
          <Tooltip.Content
            ...
            fontSize="sm"
          >
            If you use this project, consider supporting its maintainers!
          </Tooltip.Content>
        </Tooltip.Positioner>
      </Tooltip.Root>
    );
            ...
            <Menu.Trigger asChild>
              ...
              >
                <HStack gap={2}>
                  <GoHeart color="#db61a2" />
                  <Text>Sponsor</Text>
                  <GoArrowRight color="#db61a2" size={12} />
